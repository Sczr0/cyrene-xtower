// 星穹铁道角色池蒙特卡洛模拟模型
// 对应 Python 中的 HSRCharacterLogic(GenshinCharacterLogic)
...
export function runHSRCharacterDistribution(
	args: GachaArgs,
	rng: RNG,
